          ...
          >
            ...
            <div className="flex flex-wrap gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-white/10 bg-white/5 text-white text-sm font-medium hover:bg-white/10 hover:border-white/20 transition-all duration-200"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-[#0071e3]/30 bg-[#0071e3]/10 text-[#2997ff] text-sm font-medium hover:bg-[#0071e3]/20 transition-all duration-200"
              >
                ✉ Email Me
              </a>
            </div>
